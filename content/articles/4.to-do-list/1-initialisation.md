...
```shell [~/projects/todo-frontend]
cp .env.example .env
```



```yml [~/projects/todo-frontend/.env]
UID=1000
GID=1000
USMAK=0644
APP_NAME=todo-frontend
APP_URL=todo-frontend.chartman2-fr.ovh
APP_WS_URL=todo-frontend-wss.chartman2-fr.ovh
APP_VSCODE_NAME=vscode-todo-frontend
APP_VSCODE_URL=vscode-todo-frontend.chartman2-fr.ovh
APP_NETWORK=projects_local_dev
APP_STORAGE_NAME="todo-frontend"
API_BASE_URL="https://todo-backend.chartman2-fr.ovh"
...
J'utilise Traefik pour avoir des urls plus sympa (`https://todo-frontend.chartman2-fr.ovh` au lieu de `http://localhost:3000`), voilà la [configuration](/blog/article/3-docker-traefik-introduction)
...
```shell [~/projects/todo-frontend/.env]
https://<APP_URL>
...
##### ⚙️ Ajout du nom de notre application
